export default function PP() {
  return (
    <div className="prose prose-invert container">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Peru
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Horarios EZ.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Horarios EZ, accessible from{" "}
            <a
              href="https://ez.utec.fyi/"
